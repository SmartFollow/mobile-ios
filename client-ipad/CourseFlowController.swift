...
class CourseFlowController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ApiManager.sharedInstance.b(endPoint: "/api/lessons") { (result: Data?) in
            ...
            var lessons = ApiManager.parseLessons(result: result)
            var tmpArr = [String]()
...
//                        let lesson = Lesson(id: id as! Int, subjectId: subjectId as! Int, reservationId: 5 as! Int, studentClassId: studentClassId as! Int, start: start as! String, end: end as! String, subjectName)
