...
//            let StudentClass: [Student] = self.parseClassStudent(result: result)
//
//            var leftY = 200
//            var rightY = 200
//            var i = true
//            self.scrollView.contentSize.height =  (((CGFloat) (StudentClass.count / 2) * (100)) - 50.0)
...
//    }
//
//    func parseClassStudent(result: Data?) -> [Student] {
